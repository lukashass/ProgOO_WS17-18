...
public class HandyInt {
	...
	/**
	 * Constructs a new handy integer representing the integer represented by the
	 * given handy integer.
	 * 
	 * @param handyInt
	...
	// add() had to be changed so it returns a new
	// HandyInt rather than modifying the old one
	/**
	 * Returns a handy integer that represents the sum of this and the other handy
	 * integer.
	 * 
	 * @param other
	...
	// sub() had to be changed so it returns a new
	// HandyInt rather than modifying the old one
	/**
	 * Returns a handy integer that represents the result of subtracting the other
